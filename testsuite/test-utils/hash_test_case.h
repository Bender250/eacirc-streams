...
namespace testsuite {
    /** test case for functions from hash competition **/
    ...
    public:
         ...
         *
         * STRUCTURE OF TEST VECTORS (All present in test-resources/hash/{function-name}/test-vectors-{round-number}.txt)
...
#endif //EACIRC_STREAMS_HASH_TEST_CASE_H
